...
package jdk7u.jaxp.org.apache.xml.external.resolver.helpers;
 ...
 *
 * @see jdk7u.jaxp.org.apache.xml.external.resolver.CatalogManager
 *
 * @author Norman Walsh
...
public class BootstrapResolver implements EntityResolver, URIResolver {
  ...
  public BootstrapResolver() {
    URL url = this.getClass().getResource("/jdk7u/jaxp/org/apache/xml/external/resolver/etc/catalog.dtd");
    if (url != null) {
      publicMap.put(xmlCatalogPubId, url.toString());
      systemMap.put(xmlCatalogSysId, url.toString());
    }

    url = this.getClass().getResource("/jdk7u/jaxp/org/apache/xml/external/resolver/etc/catalog.rng");
    if (url != null) {
      uriMap.put(xmlCatalogRNG, url.toString());
    }

    url = this.getClass().getResource("/jdk7u/jaxp/org/apache/xml/external/resolver/etc/catalog.xsd");
    if (url != null) {
