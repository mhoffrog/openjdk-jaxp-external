 ...
 * to create is named "jdk7u.jaxp.org.apache.xml.external.utils.DTMFactory". This
...
public abstract class DTMManager
{
  ...
  private static final String defaultPropName =
    "jdk7u.jaxp.org.apache.xml.external.dtm.DTMManager";

  /** The default class name to use as the manager. */
  private static String defaultClassName =
    "jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMManagerDefault";
   ...
   * <ul>
   * <li>
   * Use the <code>jdk7u.jaxp.org.apache.xml.external.dtm.DTMManager</code> system
   * property.
   * </li>
   * <li>
   ...
   * <code>META-INF/services/jdk7u.jaxp.org.apache.xml.external.dtm.DTMManager</code>
   * in jars available to the runtime.
   * </li>
   * <li>
   * Use the default <code>DTMManager</code> classname, which is
   * <code>jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMManagerDefault</code>.
   * </li>
   * </ul>
   *
           ...
           throws DTMConfigurationException
  {
    ...
    try
    {
        if (useServicesMechanism) {
            ...
            factoryImpl = new jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMManagerDefault();
        }
    }
