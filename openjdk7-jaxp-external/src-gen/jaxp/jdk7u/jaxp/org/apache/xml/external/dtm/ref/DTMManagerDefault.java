 ...
 */
package jdk7u.jaxp.org.apache.xml.external.dtm.ref;
...
import jdk7u.jaxp.org.apache.xml.external.dtm.DTMException;
import jdk7u.jaxp.org.apache.xml.external.dtm.DTMFilter;
import jdk7u.jaxp.org.apache.xml.external.dtm.DTMIterator;
import jdk7u.jaxp.org.apache.xml.external.dtm.DTMManager;
import jdk7u.jaxp.org.apache.xml.external.dtm.DTMWSFilter;
import jdk7u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTM;
import jdk7u.jaxp.org.apache.xml.external.dtm.ref.sax2dtm.SAX2DTM;
import jdk7u.jaxp.org.apache.xml.external.dtm.ref.sax2dtm.SAX2RTFDTM;
import jdk7u.jaxp.org.apache.xml.external.res.XMLErrorResources;
...
import jdk7u.jaxp.org.apache.xml.external.utils.XMLStringFactory;
...
public class DTMManagerDefault extends DTMManager
{
        ...
        try {
          ...
          **************************************************************/
          ...
          boolean haveXercesParser =
                     ...
                     && (reader.getClass()
                               .getName()
                               .equals("jdk7u.jaxp.org.apache.xerces.external.parsers.SAXParser") );
          ...
          if (m_incremental && incremental
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("jdk7u.jaxp.org.apache.xml.external.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }
            ...
            if (JKESS_XNI_EXPERIMENT && m_incremental &&
                ...
                jdk7u.jaxp.org.apache.xerces.external.xni.parser.XMLPullParserConfiguration xpc=
            ...
            ***************************************************************/
            ...
            try {
              ...
              throw new jdk7u.jaxp.org.apache.xml.external.utils.WrappedRuntimeException(e);
            }
          } else {
            if (null == reader) {
  ...
  synchronized public int getDTMHandleFromNode(org.w3c.dom.Node node)
  {
    ...
    if (node instanceof jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeProxy)
      return ((jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeProxy) node).getDTMNodeNumber();
    ...
    else
    {
      ...
      if(node instanceof jdk7u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode)
      {
  ...
  synchronized public boolean release(DTM dtm, boolean shouldHardDelete)
  {
    ...
    if (dtm instanceof SAX2DTM)
    {
      ((SAX2DTM) dtm).clearCoRoutine();
                ...
                if(dtm instanceof DTMDefaultBase)
                {
                        jdk7u.jaxp.org.apache.xml.external.utils.SuballocatedIntVector ids=((DTMDefaultBase)dtm).getDTMIDs();
                                       ...
                                       boolean entityReferenceExpansion)
  {
    ...
    /** @todo: implement this jdk7u.jaxp.org.apache.xml.external.dtm.DTMManager abstract method */
    return null;
  }
