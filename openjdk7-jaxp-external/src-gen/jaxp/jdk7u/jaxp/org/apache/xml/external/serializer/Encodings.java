...
public final class Encodings extends Object
{
     ...
     */
    private static final String ENCODINGS_FILE = "jdk7u/jaxp/org/apache/xml/external/serializer/Encodings.properties";

    /**
     * Standard filename for properties file with encodings data.
     */
    private static final String ENCODINGS_PROP = "jdk7u.jaxp.org.apache.xalan.external.serialize.encodings";
    ...
    private final static class EncodingInfos {
        ...
        private void loadEncodingInfo() {
            try {
                ...
                throw new jdk7u.jaxp.org.apache.xml.external.serializer.utils.WrappedRuntimeException(mue);
            } catch (java.io.IOException ioe) {
                throw new jdk7u.jaxp.org.apache.xml.external.serializer.utils.WrappedRuntimeException(ioe);
            }
        }
