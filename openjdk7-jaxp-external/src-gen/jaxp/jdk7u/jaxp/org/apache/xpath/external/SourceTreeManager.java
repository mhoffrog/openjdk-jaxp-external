...
//      return ((DOMSource) source).getNode();
          ...
          throws TransformerException
  {
    ...
    try
    {
      ...
      DTM dtm;
      if(null != xowner && xowner instanceof jdk7u.jaxp.org.apache.xml.external.dtm.DTMWSFilter)
      {
        dtm = xctxt.getDTM(source, false,
                          (jdk7u.jaxp.org.apache.xml.external.dtm.DTMWSFilter)xowner, false, true);
      }
      else
      {
