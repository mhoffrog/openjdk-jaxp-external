 ...
 */
package jdk7u.jaxp.org.apache.xpath.external.compiler;
...
import jdk7u.jaxp.org.apache.xpath.external.axes.UnionPathIterator;
import jdk7u.jaxp.org.apache.xpath.external.axes.WalkerFactory;
import jdk7u.jaxp.org.apache.xpath.external.functions.FuncExtFunction;
import jdk7u.jaxp.org.apache.xpath.external.functions.FuncExtFunctionAvailable;
import jdk7u.jaxp.org.apache.xpath.external.functions.Function;
import jdk7u.jaxp.org.apache.xpath.external.functions.WrongNumberArgsException;
import jdk7u.jaxp.org.apache.xpath.external.objects.XNumber;
import jdk7u.jaxp.org.apache.xpath.external.objects.XString;
import jdk7u.jaxp.org.apache.xpath.external.operations.And;
import jdk7u.jaxp.org.apache.xpath.external.operations.Div;
import jdk7u.jaxp.org.apache.xpath.external.operations.Equals;
import jdk7u.jaxp.org.apache.xpath.external.operations.Gt;
import jdk7u.jaxp.org.apache.xpath.external.operations.Gte;
import jdk7u.jaxp.org.apache.xpath.external.operations.Lt;
import jdk7u.jaxp.org.apache.xpath.external.operations.Lte;
...
import jdk7u.jaxp.org.apache.xpath.external.operations.Neg;
import jdk7u.jaxp.org.apache.xpath.external.operations.NotEquals;
import jdk7u.jaxp.org.apache.xpath.external.operations.Operation;
import jdk7u.jaxp.org.apache.xpath.external.operations.Or;
import jdk7u.jaxp.org.apache.xpath.external.operations.Plus;
import jdk7u.jaxp.org.apache.xpath.external.operations.UnaryOperation;
import jdk7u.jaxp.org.apache.xpath.external.operations.Variable;
import jdk7u.jaxp.org.apache.xpath.external.patterns.FunctionPattern;
import jdk7u.jaxp.org.apache.xpath.external.patterns.NodeTest;
import jdk7u.jaxp.org.apache.xpath.external.patterns.StepPattern;
import jdk7u.jaxp.org.apache.xpath.external.patterns.UnionPattern;
...
//      expr.setSourceLocator(m_locator);
   ...
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Operation} instance.
   *
   * @throws TransformerException if there is a syntax or other error.
   */
   ...
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Or} instance.
   *
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.And} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.NotEquals} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Equals} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Lte} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Lt} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Gte} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Gt} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Plus} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Minus} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Mult} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Div} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Mod} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Quo} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
...
//  }
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Neg} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.String} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
  protected Expression string(int opPos) throws TransformerException
  {
    return compileUnary(new jdk7u.jaxp.org.apache.xpath.external.operations.String(), opPos);
  }
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Bool} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
  protected Expression bool(int opPos) throws TransformerException
  {
    return compileUnary(new jdk7u.jaxp.org.apache.xpath.external.operations.Bool(), opPos);
  }
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Number} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
  protected Expression number(int opPos) throws TransformerException
  {
    return compileUnary(new jdk7u.jaxp.org.apache.xpath.external.operations.Number(), opPos);
  }
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.objects.XString} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.objects.XNumber} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.operations.Variable} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * {@link jdk7u.jaxp.org.apache.xpath.external.axes.LocPathIterator} children.
   *
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.axes.LocPathIterator} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * {@link jdk7u.jaxp.org.apache.xpath.external.axes.AxesWalker} children.
   *
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.axes.LocPathIterator} instance.
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.patterns.UnionPattern} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.patterns.StepPattern} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
...
private static final boolean DEBUG = false;
   ...
   *
   * @return reference to array of {@link jdk7u.jaxp.org.apache.xpath.external.Expression} instances.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   *            {@link jdk7u.jaxp.org.apache.xpath.external.Expression}s, that will be filled in.
   *
   * @throws TransformerException
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.functions.Function} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   * @param opPos The current position in the m_opMap array.
   *
   * @return reference to {@link jdk7u.jaxp.org.apache.xpath.external.functions.FuncExtFunction} instance.
   *
   * @throws TransformerException if a error occurs creating the Expression.
   */
   ...
   *            in {@link jdk7u.jaxp.org.apache.xpath.external.res.XPATHErrorResources}, which is
