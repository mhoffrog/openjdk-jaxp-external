...
import jdk7u.jaxp.org.apache.xpath.external.ExpressionNode;
import jdk7u.jaxp.org.apache.xpath.external.XPathContext;
import jdk7u.jaxp.org.apache.xpath.external.axes.RTFIterator;
...
public class XRTreeFrag extends XObject implements Cloneable
{
  ...
  public Object object()
  {
    if (m_DTMXRTreeFrag.getXPathContext() != null)
      return new jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeIterator((DTMIterator)(new jdk7u.jaxp.org.apache.xpath.external.NodeSetDTM(m_dtmRoot, m_DTMXRTreeFrag.getXPathContext().getDTMManager())));
    else
      return super.object();
  }
   ...
   * {@link jdk7u.jaxp.org.apache.xalan.external.lib.ExsltCommon}.
  ...
  public NodeList convertToNodeset()
  {
    ...
    if (m_obj instanceof NodeList)
      ...
      return new jdk7u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeList(asNodeIterator());
  }
