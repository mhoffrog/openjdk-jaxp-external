...
final class JAXPValidationMessageFormatter {
    ...
    public static String formatMessage(Locale locale,
        ...
        if (locale != null) {
            resourceBundle =
                SecuritySupport.getResourceBundle("jdk7u.jaxp.org.apache.xerces.external.impl.msg.JAXPValidationMessages", locale);
        }
        else {
            resourceBundle =
                SecuritySupport.getResourceBundle("jdk7u.jaxp.org.apache.xerces.external.impl.msg.JAXPValidationMessages");
        }
