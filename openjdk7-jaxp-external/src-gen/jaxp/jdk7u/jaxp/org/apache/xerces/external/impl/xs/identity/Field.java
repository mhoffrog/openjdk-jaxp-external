...
package jdk7u.jaxp.org.apache.xerces.external.impl.xs.identity;

import jdk7u.jaxp.org.apache.xerces.external.impl.xpath.XPathException;
...
import jdk7u.jaxp.org.apache.xerces.external.xs.XSComplexTypeDefinition;
...
public class Field {
    ...
    public jdk7u.jaxp.org.apache.xerces.external.impl.xpath.XPath getXPath() {
        return fXPath;
    } // getXPath():jdk7u.jaxp.org.apache.xerces.external.impl.v1.schema.identity.XPath
    ...
    public static class XPath
        extends jdk7u.jaxp.org.apache.xerces.external.impl.xpath.XPath {
        ...
        public XPath(String xpath,
            ...
            for (int i=0;i<fLocationPaths.length;i++) {
                for(int j=0; j<fLocationPaths[i].steps.length; j++) {
                    jdk7u.jaxp.org.apache.xerces.external.impl.xpath.XPath.Axis axis =
