...
import jdk7u.jaxp.org.apache.xerces.external.dom.DocumentImpl;
...
public class DOMUtil {
    ...
    public static void setHidden(Node node) {
        if (node instanceof jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)
            ((jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)node).setReadOnly(true, false);
        else if (node instanceof jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)
            ((jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)node).setReadOnly(true, false);
    } // setHidden(node):void
    ...
    public static void setVisible(Node node) {
        if (node instanceof jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)
            ((jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)node).setReadOnly(false, false);
        else if (node instanceof jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)
            ((jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)node).setReadOnly(false, false);
    ...
    public static boolean isHidden(Node node) {
        if (node instanceof jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)
            return ((jdk7u.jaxp.org.apache.xerces.external.impl.xs.opti.NodeImpl)node).getReadOnly();
        else if (node instanceof jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)
            return ((jdk7u.jaxp.org.apache.xerces.external.dom.NodeImpl)node).getReadOnly();
        return false;
