...
import jdk7u.jaxp.org.apache.xerces.external.impl.xpath.XPath;
    ...
    public static void main(String[] argv) throws XNIException {
        ...
        if (DEBUG_ANY) {
            for (int i = 0; i < argv.length; i++) {
                ...
                jdk7u.jaxp.org.apache.xerces.external.parsers.SAXParser parser =
                    new jdk7u.jaxp.org.apache.xerces.external.parsers.SAXParser(symbols) {
