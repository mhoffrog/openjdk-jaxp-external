...
import jdk7u.jaxp.org.apache.xerces.external.parsers.DOMParserImpl;
import jdk7u.jaxp.org.apache.xerces.external.parsers.DTDConfiguration;
...
import jdk7u.jaxp.org.apache.xml.external.serialize.DOMSerializerImpl;
...
public class CoreDOMImplementationImpl
    ...
    private int docAndDoctypeCounter = 0;
         ...
         * At this writing, jdk7u.jaxp.org.apache.xerces.external.dom supports only XML.
         *
        ...
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            if(freeValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jdk7u.jaxp.org.apache.xerces.external.impl.xs.XMLSchemaValidator",
            ...
            if(freeDTDValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jdk7u.jaxp.org.apache.xerces.external.impl.dtd.XMLDTDValidator",
                                ObjectFactory.findClassLoader(),
                                true));
            }
            // return first available validator
