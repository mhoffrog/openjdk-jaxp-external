...
import jdk7u.jaxp.org.apache.bcel.external.generic.ClassGen;
...
public class ClassGenerator extends ClassGen {
    ...
    public ClassGenerator(String class_name, String super_class_name,
        ...
        if (stylesheet.isMultiDocument()) {
            _domClass = "jdk7u.jaxp.org.apache.xalan.external.xsltc.dom.MultiDOM";
            _domClassSig = "Ljdk7u/jaxp/org/apache/xalan/external/xsltc/dom/MultiDOM;";
        }
        else {
            _domClass = "jdk7u.jaxp.org.apache.xalan.external.xsltc.dom.DOMAdapter";
            _domClassSig = "Ljdk7u/jaxp/org/apache/xalan/external/xsltc/dom/DOMAdapter;";
        }
        _applyTemplatesSig = "("
