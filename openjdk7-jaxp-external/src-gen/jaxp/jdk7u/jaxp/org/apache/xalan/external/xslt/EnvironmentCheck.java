 ...
 * <code>
 * java jdk7u.jaxp.org.apache.xalan.external.xslt.EnvironmentCheck [-out outFile]
 * </code></p>
 *
...
//              || "xalan.jar".equalsIgnoreCase(jarName))
  ...
  protected void checkProcessorVersion(Hashtable h)
  {
    ...
    try
    {
      final String XALAN1_VERSION_CLASS =
        "jdk7u.jaxp.org.apache.xalan.external.xslt.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_VERSION_CLASS =
        "jdk7u.jaxp.org.apache.xalan.external.processor.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_2_VERSION_CLASS =
        "jdk7u.jaxp.org.apache.xalan.external.Version";
  ...
  protected void checkParserVersion(Hashtable h)
  {
    ...
    try
    {
      final String XERCES1_VERSION_CLASS = "jdk7u.jaxp.org.apache.xerces.external.framework.Version";
    ...
    try
    {
      final String XERCES2_VERSION_CLASS = "jdk7u.jaxp.org.apache.xerces.external.impl.Version";
