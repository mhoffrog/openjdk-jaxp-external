...
package jdk8u.jaxp.xml.external.stream.dtd;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.DTDGrammar;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.XMLAttributeDecl;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.XMLElementDecl;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.XMLSimpleType;
        ...
        while (attlistIndex != -1) {
            ...
            if (!cdata || required || attValue != null) {
                ...
                if (fNamespaceContext != null && attRawName.startsWith(XMLConstants.XMLNS_ATTRIBUTE)) {
                    ...
                    if (!((jdk8u.jaxp.org.apache.xerces.external.util.
