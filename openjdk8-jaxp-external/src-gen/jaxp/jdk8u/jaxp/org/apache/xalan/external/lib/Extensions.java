...
import jdk8u.jaxp.org.apache.xalan.external.xslt.EnvironmentCheck;
...
{
    static final String JDK_DEFAULT_DOM = "jdk8u.jaxp.org.apache.xerces.external.jaxp.DocumentBuilderFactoryImpl";
  /**
   ...
   *
   * <p>Simply calls the {@link jdk8u.jaxp.org.apache.xalan.external.xslt.EnvironmentCheck}
        ...
        Document factoryDocument)
  {
    ...
    try
    {
      ...
      jdk8u.jaxp.org.apache.xml.external.utils.Hashtree2Node.appendHashToNode(report, "whichReport",
   ...
   * @return an instance of DOM Document
   ...
   private static Document getDocument()
   {
        ...
        {
            throw new jdk8u.jaxp.org.apache.xml.external.utils.WrappedRuntimeException(pce);
        }
    }
}
