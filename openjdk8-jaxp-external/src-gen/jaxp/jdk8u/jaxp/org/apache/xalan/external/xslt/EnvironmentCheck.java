 ...
 * <code>
 * java jdk8u.jaxp.org.apache.xalan.external.xslt.EnvironmentCheck [-out outFile]
 * </code></p>
 *
...
//              || "xalan.jar".equalsIgnoreCase(jarName))
  ...
  protected void checkProcessorVersion(Map<String, Object> h)
  {
    ...
    try
    {
      final String XALAN1_VERSION_CLASS =
        "jdk8u.jaxp.org.apache.xalan.external.xslt.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_VERSION_CLASS =
        "jdk8u.jaxp.org.apache.xalan.external.processor.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_2_VERSION_CLASS =
        "jdk8u.jaxp.org.apache.xalan.external.Version";
  ...
  protected void checkParserVersion(Map<String, Object> h)
  {
    ...
    try
    {
      final String XERCES1_VERSION_CLASS = "jdk8u.jaxp.org.apache.xerces.external.framework.Version";
    ...
    try
    {
      final String XERCES2_VERSION_CLASS = "jdk8u.jaxp.org.apache.xerces.external.impl.Version";
