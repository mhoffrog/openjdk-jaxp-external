...
import jdk8u.jaxp.org.apache.xerces.external.parsers.DOMParserImpl;
import jdk8u.jaxp.org.apache.xerces.external.parsers.DTDConfiguration;
...
import jdk8u.jaxp.org.apache.xml.external.serialize.DOMSerializerImpl;
...
public class CoreDOMImplementationImpl
    ...
    private int docAndDoctypeCounter = 0;
         ...
         * At this writing, jdk8u.jaxp.org.apache.xerces.external.dom supports only XML.
         *
            ...
            if ((feature.equalsIgnoreCase("+XPath"))
                ...
                try {
                    Class xpathClass = ObjectFactory.findProviderClass(
                        "jdk8u.jaxp.org.apache.xpath.external.domapi.XPathEvaluatorImpl", true);
        ...
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            if(freeValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jdk8u.jaxp.org.apache.xerces.external.impl.xs.XMLSchemaValidator",
            ...
            if(freeDTDValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jdk8u.jaxp.org.apache.xerces.external.impl.dtd.XMLDTDValidator",
                                ObjectFactory.findClassLoader(),
                                true));
            }
            // return first available validator
