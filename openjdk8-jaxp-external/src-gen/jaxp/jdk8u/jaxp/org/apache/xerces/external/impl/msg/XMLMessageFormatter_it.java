...
package jdk8u.jaxp.org.apache.xerces.external.impl.msg;
...
public class XMLMessageFormatter_it implements MessageFormatter {
    ...
    public String formatMessage(Locale locale, String key, Object[] arguments)
        ...
        if (fResourceBundle == null || locale != fLocale) {
            if (locale != null) {
                fResourceBundle = SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.msg.XMLMessages", locale);
                // memorize the most-recent locale
                fLocale = locale;
            }
            if (fResourceBundle == null)
                fResourceBundle = SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.msg.XMLMessages");
        }
