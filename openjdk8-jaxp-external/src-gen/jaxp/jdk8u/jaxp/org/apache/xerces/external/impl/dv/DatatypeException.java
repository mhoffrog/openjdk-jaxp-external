...
public class DatatypeException extends Exception {
    ...
    public String getMessage() {
        ...
        resourceBundle = SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.msg.XMLSchemaMessages");
        if (resourceBundle == null)
            throw new MissingResourceException("Property file not found!", "jdk8u.jaxp.org.apache.xerces.external.impl.msg.XMLSchemaMessages", key);

        String msg = resourceBundle.getString(key);
        if (msg == null) {
            msg = resourceBundle.getString("BadMessageKey");
            throw new MissingResourceException(msg, "jdk8u.jaxp.org.apache.xerces.external.impl.msg.XMLSchemaMessages", key);
        }
