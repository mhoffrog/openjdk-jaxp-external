...
import jdk8u.jaxp.org.apache.xerces.external.impl.xpath.XPath;
    ...
    public static void main(String[] argv) throws XNIException {
        ...
        if (DEBUG_ANY) {
            for (int i = 0; i < argv.length; i++) {
                ...
                jdk8u.jaxp.org.apache.xerces.external.parsers.SAXParser parser =
                    new jdk8u.jaxp.org.apache.xerces.external.parsers.SAXParser(symbols) {
