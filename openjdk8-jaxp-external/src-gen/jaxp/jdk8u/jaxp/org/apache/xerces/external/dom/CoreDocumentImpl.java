...
public class CoreDocumentImpl
    ...
    public String getBaseURI() {
        if (fDocumentURI != null && fDocumentURI.length() != 0 ) {// attribute value is always empty string
            ...
            catch (jdk8u.jaxp.org.apache.xerces.external.util.URI.MalformedURIException e){
    ...
    public Node adoptNode(Node source) {
        ...
        if (source == null ) {
            ...
            if (thisImpl != otherImpl) {
                ...
                if (thisImpl instanceof jdk8u.jaxp.org.apache.xerces.external.dom.DOMImplementationImpl &&
                        otherImpl instanceof jdk8u.jaxp.org.apache.xerces.external.dom.DeferredDOMImplementationImpl) {
                    // traverse the DOM and expand deffered nodes and then allow adoption
                    undeferChildren (node);
                } else if ( thisImpl instanceof jdk8u.jaxp.org.apache.xerces.external.dom.DeferredDOMImplementationImpl
                        && otherImpl instanceof jdk8u.jaxp.org.apache.xerces.external.dom.DOMImplementationImpl) {
