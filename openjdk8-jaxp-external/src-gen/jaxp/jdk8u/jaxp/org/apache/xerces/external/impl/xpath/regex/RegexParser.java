...
package jdk8u.jaxp.org.apache.xerces.external.impl.xpath.regex;
...
class RegexParser {
    ...
    public void setLocale(Locale locale) {
        try {
            if (locale != null) {
                this.resources = SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.xpath.regex.message", locale);
            }
            else {
                this.resources = SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.xpath.regex.message");
            }
        }
