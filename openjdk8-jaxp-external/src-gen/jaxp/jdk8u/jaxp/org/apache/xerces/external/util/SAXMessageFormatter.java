...
public class SAXMessageFormatter {
    ...
    public static String formatMessage(Locale locale,
        ...
        if (locale != null) {
            resourceBundle =
                SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.msg.SAXMessages", locale);
        }
        else {
            resourceBundle =
                SecuritySupport.getResourceBundle("jdk8u.jaxp.org.apache.xerces.external.impl.msg.SAXMessages");
        }
