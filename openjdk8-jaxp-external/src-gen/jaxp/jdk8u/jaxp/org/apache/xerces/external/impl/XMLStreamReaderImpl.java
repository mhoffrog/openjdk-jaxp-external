...
import jdk8u.jaxp.org.apache.xerces.external.util.NamespaceContextWrapper;
...
import jdk8u.jaxp.xml.external.stream.StaxErrorReporter;
import jdk8u.jaxp.xml.external.stream.XMLEntityStorage;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.DTDGrammar;
import jdk8u.jaxp.xml.external.stream.dtd.nonvalidating.XMLNotationDecl;
import jdk8u.jaxp.xml.external.stream.events.EntityDeclarationImpl;
import jdk8u.jaxp.xml.external.stream.events.NotationDeclarationImpl;
...
public class XMLStreamReaderImpl implements javax.xml.stream.XMLStreamReader {
    ...
    */
    ...
    private void switchToXML11Scanner() throws IOException{
        ...
        jdk8u.jaxp.org.apache.xerces.external.xni.NamespaceContext oldNamespaceContext = fScanner.fNamespaceContext;
     ...
     * @return
     */
    public javax.xml.namespace.QName convertXNIQNametoJavaxQName(jdk8u.jaxp.org.apache.xerces.external.xni.QName qname){
