...
public class XNodeSetForDOM extends XNodeSet
{
  ...
  public XNodeSetForDOM(NodeList nodeList, XPathContext xctxt)
  {
    ...
    // m_obj=new jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM(nodeList, xctxt);
    jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM nsdtm=new jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM(nodeList, xctxt);
  ...
  public XNodeSetForDOM(NodeIterator nodeIter, XPathContext xctxt)
  {
    ...
    // folks to request length through an accessor, so we can defer this
    // retrieval... but that requires an API change.
    // m_obj = new jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM(nodeIter, xctxt);
    jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM nsdtm=new jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM(nodeIter, xctxt);
    m_last=nsdtm.getLength();
    setObject(nsdtm);
  }
