...
import jdk8u.jaxp.org.apache.xml.external.utils.NodeVector;
import jdk8u.jaxp.org.apache.xml.external.utils.ObjectStack;
import jdk8u.jaxp.org.apache.xml.external.utils.PrefixResolver;
import jdk8u.jaxp.org.apache.xml.external.utils.XMLString;
import jdk8u.jaxp.org.apache.xpath.external.axes.SubContextList;
import jdk8u.jaxp.org.apache.xpath.external.objects.DTMXRTreeFrag;
...
//
  ...
  public DTMIterator createDTMIterator(int node)
  {
    ...
    DTMIterator iter = new jdk8u.jaxp.org.apache.xpath.external.axes.OneStepIteratorForward(Axis.SELF);
  ...
  private void init(boolean useServicesMechanism) {
    ...
    m_dtmManager = DTMManager.newInstance(
                   jdk8u.jaxp.org.apache.xpath.external.objects.XMLStringFactoryImpl.getFactory()
                   );
  }
  ...
  public final ErrorListener getErrorListener()
  {
    ...
    if (null == retval)
    {
      if (null == m_defaultErrorListener)
        m_defaultErrorListener = new jdk8u.jaxp.org.apache.xml.external.utils.DefaultErrorHandler();
...
//  private NodeVector m_currentNodes = new NodeVector();
  ...
  public jdk8u.jaxp.org.apache.xpath.external.axes.SubContextList getCurrentNodeList()
  {
    return m_axesIteratorStack.isEmpty()
  ...
  public class XPathExpressionContext implements ExpressionContext
  {
    ...
    {
      return new jdk8u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeIterator(getContextNodeList());
    }
    ...
    public final XObject getVariableOrParam(jdk8u.jaxp.org.apache.xml.external.utils.QName qname)
              throws javax.xml.transform.TransformerException
    {
