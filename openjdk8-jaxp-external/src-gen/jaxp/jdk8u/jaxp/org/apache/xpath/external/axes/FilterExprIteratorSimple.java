...
import jdk8u.jaxp.org.apache.xpath.external.VariableStack;
...
public class FilterExprIteratorSimple extends LocPathIterator
{
  ...
  public static XNodeSet executeFilterExpr(int context, XPathContext xctxt,
                                                                                                ...
                                                                                                int stackFrame,
                                                                                                Expression expr )
    throws jdk8u.jaxp.org.apache.xml.external.utils.WrappedRuntimeException
  {
    ...
    try
    {
      ...
      if (isTopLevel)
      {
        ...
        result = (jdk8u.jaxp.org.apache.xpath.external.objects.XNodeSet) expr.execute(xctxt);
    ...
    catch (javax.xml.transform.TransformerException se)
    {
      ...
      // TODO: Fix...
      throw new jdk8u.jaxp.org.apache.xml.external.utils.WrappedRuntimeException(se);
    }
    finally
    {
