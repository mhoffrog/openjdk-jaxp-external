...
public class VariableStack implements Cloneable
{
  ...
  public XObject getVariableOrParam(
          XPathContext xctxt, jdk8u.jaxp.org.apache.xml.external.utils.QName qname)
            throws javax.xml.transform.TransformerException
  {

    // J2SE does not support Xalan interpretive
        /*
    jdk8u.jaxp.org.apache.xml.external.utils.PrefixResolver prefixResolver =
    ...
    if (prefixResolver instanceof jdk8u.jaxp.org.apache.xalan.external.templates.ElemTemplateElement)
    {

      jdk8u.jaxp.org.apache.xalan.external.templates.ElemVariable vvar;

      jdk8u.jaxp.org.apache.xalan.external.templates.ElemTemplateElement prev =
        (jdk8u.jaxp.org.apache.xalan.external.templates.ElemTemplateElement) prefixResolver;

      if (!(prev instanceof jdk8u.jaxp.org.apache.xalan.external.templates.Stylesheet))
      {
        while ( !(prev.getParentNode() instanceof jdk8u.jaxp.org.apache.xalan.external.templates.Stylesheet) )
        {
