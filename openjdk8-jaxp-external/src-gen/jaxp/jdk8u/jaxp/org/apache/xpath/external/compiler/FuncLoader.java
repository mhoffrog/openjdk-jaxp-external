...
public class FuncLoader
{
   ...
   *  found in {@link jdk8u.jaxp.org.apache.xpath.external.compiler.FunctionTable}, but may
   ...
   * 'jdk8u.jaxp.org.apache.xpath.external.functions'.
   *
   * @return The class name of the {jdk8u.jaxp.org.apache.xpath.external.functions.Function} class.
   */
   ...
   *
   * @param funcName The class name of the {jdk8u.jaxp.org.apache.xpath.external.functions.Function}
   *             class, which, if it does not have a '.' in it, is assumed to
   *             be relative to 'jdk8u.jaxp.org.apache.xpath.external.functions'.
  ...
  Function getFunction() throws TransformerException
  {
    try
    {
      ...
      if (className.indexOf(".") < 0) {
        className = "jdk8u.jaxp.org.apache.xpath.external.functions." + className;
      }
      //hack for loading only built-in function classes.
      String subString = className.substring(0,className.lastIndexOf('.'));
      if(!(subString.equals ("jdk8u.jaxp.org.apache.xalan.external.templates") ||
           subString.equals ("jdk8u.jaxp.org.apache.xpath.external.functions"))) {
