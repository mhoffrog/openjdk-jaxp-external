...
import jdk8u.jaxp.org.apache.xpath.external.ExpressionNode;
import jdk8u.jaxp.org.apache.xpath.external.XPathContext;
import jdk8u.jaxp.org.apache.xpath.external.axes.RTFIterator;
...
public class XRTreeFrag extends XObject implements Cloneable
{
  ...
  public Object object()
  {
    if (m_DTMXRTreeFrag.getXPathContext() != null)
      return new jdk8u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeIterator((DTMIterator)(new jdk8u.jaxp.org.apache.xpath.external.NodeSetDTM(m_dtmRoot, m_DTMXRTreeFrag.getXPathContext().getDTMManager())));
    else
      return super.object();
  }
   ...
   */
  public void appendToFsb(jdk8u.jaxp.org.apache.xml.external.utils.FastStringBuffer fsb)
  {
   ...
   * {@link jdk8u.jaxp.org.apache.xalan.external.lib.ExsltCommon}.
  ...
  public NodeList convertToNodeset()
  {
    ...
    if (m_obj instanceof NodeList)
      ...
      return new jdk8u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeList(asNodeIterator());
  }
