 ...
 */
package jdk8u.jaxp.org.apache.xml.external.dtm.ref;
...
import jdk8u.jaxp.org.apache.xml.external.dtm.DTMException;
...
import jdk8u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTM;
import jdk8u.jaxp.org.apache.xml.external.dtm.ref.sax2dtm.SAX2DTM;
import jdk8u.jaxp.org.apache.xml.external.dtm.ref.sax2dtm.SAX2RTFDTM;
import jdk8u.jaxp.org.apache.xml.external.res.XMLErrorResources;
import jdk8u.jaxp.org.apache.xml.external.res.XMLMessages;
...
public class DTMManagerDefault extends DTMManager
{
        ...
        try {
          ...
          **************************************************************/
          ...
          boolean haveXercesParser =
                     ...
                     && (reader.getClass()
                               .getName()
                               .equals("jdk8u.jaxp.org.apache.xerces.external.parsers.SAXParser") );
          ...
          if (m_incremental && incremental
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("jdk8u.jaxp.org.apache.xml.external.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }
            ...
            if (JKESS_XNI_EXPERIMENT && m_incremental &&
                ...
                jdk8u.jaxp.org.apache.xerces.external.xni.parser.XMLPullParserConfiguration xpc=
            ...
            ***************************************************************/
            ...
            try {
              ...
              throw new jdk8u.jaxp.org.apache.xml.external.utils.WrappedRuntimeException(e);
            }
          } else {
            if (null == reader) {
  ...
  synchronized public int getDTMHandleFromNode(org.w3c.dom.Node node)
  {
    ...
    if (node instanceof jdk8u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeProxy)
      return ((jdk8u.jaxp.org.apache.xml.external.dtm.ref.DTMNodeProxy) node).getDTMNodeNumber();
    ...
    else
    {
      ...
      if(node instanceof jdk8u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode)
      {
  ...
  synchronized public boolean release(DTM dtm, boolean shouldHardDelete)
  {
    ...
    if (dtm instanceof SAX2DTM)
    {
      ((SAX2DTM) dtm).clearCoRoutine();
                ...
                if(dtm instanceof DTMDefaultBase)
                {
                        jdk8u.jaxp.org.apache.xml.external.utils.SuballocatedIntVector ids=((DTMDefaultBase)dtm).getDTMIDs();
                                       ...
                                       boolean entityReferenceExpansion)
  {
    ...
    /** @todo: implement this jdk8u.jaxp.org.apache.xml.external.dtm.DTMManager abstract method */
    return null;
  }
