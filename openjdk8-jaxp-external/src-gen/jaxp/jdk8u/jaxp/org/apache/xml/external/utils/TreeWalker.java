...
public class TreeWalker
{
  ...
  {
    if(m_contentHandler instanceof jdk8u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTM.CharacterNodeHandler)
    {
      ((jdk8u.jaxp.org.apache.xml.external.dtm.ref.dom2dtm.DOM2DTM.CharacterNodeHandler)m_contentHandler).characters(node);
    }
    else
    {
